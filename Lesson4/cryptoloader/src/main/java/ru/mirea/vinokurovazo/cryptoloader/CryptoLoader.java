package ru.mirea.vinokurovazo.cryptoloader;
...
public class CryptoLoader extends AsyncTaskLoader<String> {
    ...
    public String loadInBackground() {
        Log.d(TAG, "Дешифровка в процессе");
        ...
        try {
            ...
            Log.d(TAG, "Дешифровка прошла успешно, результат: " + decryptedText);
            return decryptedText;
        } catch (RuntimeException e) {
            Log.e(TAG, "Ошибка дешифрования", e);
