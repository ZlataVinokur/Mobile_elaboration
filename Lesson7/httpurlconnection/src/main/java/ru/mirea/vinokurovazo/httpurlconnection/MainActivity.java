package ru.mirea.vinokurovazo.httpurlconnection;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void checkInternetAndFetch() {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            Toast.makeText(MainActivity.this, "Нет доступа в интернет", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private class DownloadIpInfoTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result == null) {
                tvStatus.setText("Ошибка при загрузке IP");
                return;
            }
            ...
            try {
                ...
                tvStatus.setText("IP загружен");
                new DownloadWeatherTask().execute(latitude, longitude);

            } catch (JSONException e) {
                e.printStackTrace();
                tvStatus.setText("Ошибка разбора JSON");
            }
        }
    }
