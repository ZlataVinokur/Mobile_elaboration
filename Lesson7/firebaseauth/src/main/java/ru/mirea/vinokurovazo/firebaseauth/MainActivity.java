package ru.mirea.vinokurovazo.firebaseauth;
...
import ru.mirea.vinokurovazo.firebaseauth.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean validateForm() {
        ...
        if (TextUtils.isEmpty(password)) {
            ...
            binding.passwordEditText.setError("Must be at least 4 characters.");
            valid = false;
        } else {
