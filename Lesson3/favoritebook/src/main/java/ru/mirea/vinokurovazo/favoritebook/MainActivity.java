package ru.mirea.vinokurovazo.favoritebook;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonOpenInput.setOnClickListener(v -> {
            ...
            intent.putExtra(BOOK_NAME_KEY, "Стрекоза и муровей");
            intent.putExtra(QUOTES_KEY, "Попрыгунья стрекоза лето красное пропела; Оглянуться не успела, как зима катит в глаза.");
